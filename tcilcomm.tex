...
\typeout{TCILCOMM Macros for TCI styles <16 Dec 93>.}
...
% The following was used for greek bf in the past.
...
%
% Newfields have a bad habit of putting blanks in front of
% and in back of their arguments.  Here are some macros to
% remove the blanks

\def\eatfrontblank#1{#1}% TeX does this just by reading a parameter

\def\eatblank#1{\expandafter\eatfrontblank#1}
%
