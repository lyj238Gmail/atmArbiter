...
NOC experiment network. The test patterns generated in this work are used to test the function of the arbiter. %Here $N$ can reach the number of requests of a real-world
%arbiter.
